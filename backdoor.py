# This library is from Chapter 3 and contains all the necessary defines for process creation
import sys
from ctypes import *
...
path_to_exe = "C:\\Program Files (x86)\\HxD\HxD.exe"
...
# and stores its PID so that we can do our injection
