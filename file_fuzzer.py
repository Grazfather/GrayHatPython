...
class file_fuzzer:
    def __init__(self, exe_path, ext, notify):
        ...
        self.recipients = ['grazfather@gmail.com']
        self.sender = ['grazfather@gmail.com']
    ...
    # Our primary debugger thread that the application runs under
    def start_debugger(self):
        print "[*] Starting the debugger for iteration: %s" % self.iteration
        self.running = True
        self.dbg = pydbg()
    ...
    # Out access violation handler that traps the crash information and stores it
    ...
    # to run for a few seconds and then terminates it
    ...
    # Our emailing routing to ship out crash information
    def notify(self):
    ...
    def mutate_file(self):
        ...
        # Apply it to the buffer, wea re just splicing in our fuzz data
